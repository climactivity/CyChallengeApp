...
<div class="bg-white">
	...
	<div class="prose h-screen overflow-scroll p-4 pb-40">
		...
		<p>Klimaschutz For All e. V.<br />Ritterhuder Str. 23<br />28237 Bremen</p>
		<p><strong>Telefon:</strong> 0421 16767749</p>
		<p>E-Mail: info@climactivity.de</p>
		<p>Vertreten durch:<br />Ulrich Wischnath, Eva Bischof, Ricarda Förster, Kathrin Wischnath</p>
		<p>Datenschutzbeauftragte/r beim Anbieter ist:</p>
		<p><strong>Ulrich Wischnath</strong></p>
		<p><!-- /wp:paragraph --></p>
		<p><!-- wp:heading {"level":3} --></p>
		...
		<p>
			<strong
				...
				ein Widerspruch gegen die Datenverarbeitung zum Zwecke der Direktwerbung statthaft.</strong
			>
		</p>
		<p><!-- /wp:paragraph --></p>
		<p><!-- wp:heading {"level":3} --></p>
		...
		<p><!-- wp:paragraph --></p>
		<p>
			In unserem Internetauftritt setzen wir Jetpack mit der Erweiterung „WordPress Stats“ ein.
			Hierbei handelt es sich um einen Webanalysedienst der Automattic Inc., 132 Hawthorne Street,
			San Francisco, CA 94107, USA, nachfolgend nur „Automattic“ genannt.
		</p>
		<p>
			Der Dienst Jetpack – WordPress Stats dient zur Analyse des Nutzungsverhaltens unseres
		...
		<p>
			Zur Analyse des Nutzungsverhaltens speichert Jetpack – WordPress Stats Cookies über Ihren
			Internet-Browser auf Ihrem Endgerät.
		</p>
		<p>
			Bei der Verarbeitung werden Ihre IP-Adresse, die Website(s) unseres Internetauftritts, die Sie
			besuchen, die Website, von der aus Sie auf unseren Internetauftritt gewechselt haben (Referrer
			URL), Ihre Verweildauer auf unserem Internetauftritt sowie die Häufigkeit des Aufrufs einer
			unserer Websites erfasst. Die dabei erhobenen Daten werden auf einem Server von Automattic in
			den USA gespeichert. Ihre IP-Adresse wird allerdings unverzüglich nach der Verarbeitung und
			noch vor ihrer Speicherung anonymisiert.
		</p>
		<p>
			Falls Sie mit dieser Verarbeitung nicht einverstanden sind, haben Sie die Möglichkeit, die
			Speicherung des Cookies durch eine Einstellung in Ihrem Internet-Browsers zu verhindern.
			Nähere Informationen hierzu finden Sie vorstehend unter „Cookies“.
		</p>
		<p><!-- /wp:paragraph --></p>
		<p><!-- wp:heading {"level":4} --></p>
		<h4>OpenStreetMap</h4>
		...
		<p><!-- wp:paragraph --></p>
		<p>
			Für Anfahrtsbeschreibungen setzen wir OpenStreetMap, einen Dienst der OpenStreetMap
			Foundation, St John’s Innovation Centre, Cowley Road, Cambridge, CB 4 0 WS, United Kingdom,
			nachfolgend nur „OpenStreetMap“ genannt, ein.
		</p>
		<p>
			Bei Aufruf einer unserer Internetseiten, in die der Dienst OpenStreetMap eingebunden ist, wird
			durch OpenStreetMap ein Cookie über Ihren Internet-Browser auf Ihrem Endgerät gespeichert.
			Hierdurch werden Ihre Nutzereinstellungen und Nutzerdaten zum Zwecke der Anzeige der Seite
			bzw. zur Gewährleistung der Funktionalität des Dienstes OpenStreetMap verarbeitet. Durch diese
			Verarbeitung kann OpenStreetMap erkennen, von welcher Internetseite Ihre Anfrage gesendet
			worden ist und an welche IP- Adresse die Darstellung der Anfahrt übermittelt werden
			soll.&nbsp;
		</p>
		<p>
		...
		<p>
			Weitere Informationen zur Erhebung und Nutzung der Daten sowie zu Ihren Rechten und
			Möglichkeiten zum Schutz Ihrer Privatsphäre an.
		</p>
		<h3>IV. Übertragung der Nutzerdaten auf andere Rechtsträger</h3>
		<p>
			Im Rahmen der Monetarisierung von climactivity wird in Zukunft die Gründung einer weiteren
			gemeinnützigen Gesellschaft angestrebt. Der derzeitige Rechtsträger, Klimaschutz For All e.V.,
			wird im Rahmen dieser Umfirmierung der gemeinnützigen Gesellschaft das geistige Eigentum an
			den Entwicklungen sowie die Userdaten aus der climactivity-App und dem Sozialen Netzwerk
			übertragen. Eine Weitergabe von Nutzer:innendaten an unbekannte Dritte erfolgt in keinem Fall.
		</p>
		<p>
			<a
				href="https://www.ratgeberrecht.eu/leistungen/muster-datenschutzerklaerung.html"
				target="_blank"
				rel="noreferrer noopener">Muster-Datenschutzerklärung</a
			>
			der
			<a
				href="https://www.ratgeberrecht.eu/datenschutz/datenschutzerklaerung-generator-dsgvo.html"
				target="_blank"
				rel="noreferrer noopener">Anwaltskanzlei Weiß &amp; Partner</a
			>
		</p>
		<p><!-- /wp:paragraph --></p>
	</div>
