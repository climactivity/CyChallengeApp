...
<div class="mx-4 p-4 rounded shadow bg-white ">
	<div class="prose p-4 mb-20 mx-auto">
		...
		<p>
			...
			durch: Ulrich Wischnath, Eva Bischof, Johannes Dabringhausen, Kathrin Wischnath
		</p>

		<h2>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
		<p>
			climactivity e. V. Ritterhuder Str. 23 28237 Bremen Tel.: 0421 – 1676 7749 Wir sind nicht
		...
		<p>
			...
			Rechtsverletzungen werden wir derartige Links umgehend entfernen.Entfernung oder Sperrung der
